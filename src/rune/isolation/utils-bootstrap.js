...
globalThis.utils = {
  ...
  shell: {
    ...
    job: {
      ...
      write:     (id, text) => $__utils_shell_job_write.apply(undefined, [id, text], { arguments: { copy: true }, result: { promise: true } }),
      writeEof:  (id) => $__utils_shell_job_write_eof.apply(undefined, [id], { arguments: { copy: true }, result: { promise: true } }),
    },
  },
  section: {
  ...
  csv: {
    ...
    headers:           (p, o)    => $__utils_csv_headers.apply(undefined, [p, o], { arguments: { copy: true }, result: { promise: true, copy: true } }),
    count:             (p, o)    => $__utils_csv_count.apply(undefined, [p, o], { arguments: { copy: true }, result: { promise: true } }),
    append:            (p, r, o) => $__utils_csv_append.apply(undefined, [p, r, o], { arguments: { copy: true }, result: { promise: true } }),
    appendObjects:     (p, d, o) => $__utils_csv_append_objects.apply(undefined, [p, d, o], { arguments: { copy: true }, result: { promise: true } }),
