...
declare namespace sqlite {
   ...
   * @param location Storage scope: "@local-project-sqlite", "@global-project-sqlite", "@global-plugin-sqlite", "@local-project-plugin-sqlite", "@global-project-plugin-sqlite", or a relative path
